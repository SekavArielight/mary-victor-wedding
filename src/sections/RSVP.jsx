...
const RSVP = () => {
  ...
  <p className="mb-10 text-gray-600">
    We are excited to share this special day with you. Please let us know if you’ll be able to attend!
  </p>
  ...
  <form className="space-y-8">
    ...
    <input type="email" placeholder="Email Address*" className="input-style w-full" />
    ...
    <button type="submit" className="bg-[#5c1a00] text-white px-6 py-3 rounded-md font-medium hover:bg-[#411200]">
      Submit RSVP
    </button>
  </form>

  <p className="mt-8 text-sm text-gray-600">
    Thank you for celebrating with us! Your presence is the perfect present. ❤️
  </p>
</section>
